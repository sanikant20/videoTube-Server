...
//               onClick={toggleTheme} className={`theme-toggle-btn ${theme === 'light' ? 'btn-dark text-light' : 'btn-light text-dark'} w-100 text-start`}>
...
//           <Offcanvas.Title className={`${theme === 'light' ? 'text-dark' : 'text-white'}`}>VideoTube</Offcanvas.Title>
//         </Offcanvas.Header>
//         <Offcanvas.Body>
